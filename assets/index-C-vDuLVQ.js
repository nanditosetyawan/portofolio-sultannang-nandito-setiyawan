      ...
      <div class="about-wid-inner">
        ...
        <div class="about-wid-stats">
          ...
          <div class="about-wid-stat">
            ...
            -->
            <span class="about-wid-num">${y()}</span>
          ...
          <div class="about-wid-stat about-wid-stat--center">
            ...
            -->
            <span class="about-wid-num">${(()=>{let e=Array.isArray(x)?x.length:0;return e>=99?`99+`:`${e}`})()}</span>
          ...
          <div class="about-wid-stat">
            ...
            -->
            <span class="about-wid-num">0</span>
      ...
      <article class="accordion elevated project-item ${t>=3?`hidden extra-project`:``}" data-accordion>
        <button class="project-btn" data-accordion-btn>
          ...
          <div class="project-toggle">
            <img src="${j}" class="chev project-chev" alt="Toggle">
          </div>
        </button>
    ...
    <section id="achievements" class="stage alt relative section-wrap achievement-section">
      <div class="achievement-container">
        ...
        <div class="achievement-list space-y-4">
          ${P.map((e,t)=>{let n=t>=2?`hidden extra-achieve`:``,r=e.certificates.length>1?`${e.certificates.length} FILES`:`PREVIEW`;return`
      <article class="accordion elevated achievement-item ${n}" data-accordion>
        <button class="achievement-btn" data-accordion-btn>
          ...
          <div class="achievement-toggle">
            <img src="${I}" class="chev achievement-chev" alt="Toggle">
          </div>
        </button>
