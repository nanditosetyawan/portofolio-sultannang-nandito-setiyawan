...
`,j=e=>typeof e==`string`&&e.startsWith(`http`),M=e=>e.isWebsite===!0&&j(e.liveUrl),N=e=>[`video`,`mp4`,`webm`].includes(e),P=e=>e===`pdf`,F=e=>{let t=e.techStack.map(e=>e.toLowerCase()),n=e.tags.map(e=>e.toLowerCase());return t.some(e=>[`qgis`,`gis`,`spatial`,`arcgis`].includes(e))?`GIS Project • Spatial Analysis`:t.some(e=>[`packet tracer`,`cisco`,`network`].includes(e))||n.some(e=>[`network`,`packet tracer`].includes(e))?`Network Simulation • Packet Tracer`:t.some(e=>[`android`,`kotlin`,`android studio`].includes(e))?`Android Application • Mobile Preview`:t.some(e=>[`figma`,`ui`,`ux`,`design`].includes(e))?`UI/UX Design • Figma Prototype`:t.some(e=>[`c++`,`c`,`java`].includes(e))?`Desktop Application Preview`:n.some(e=>[`pdf`,`documentation`,`docs`,`report`].includes(e))?`Project Documentation Preview`:`Local Project • Screenshots / Demo Preview`},I=e=>e.media&&e.media.length>0?e.media:[{type:`image`,src:e.image}],L=`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>`,R=`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>`,ie=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>`,ae=`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>`,oe=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>`,se=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>`,z=`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>`,B=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>`,V=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>`,H=`<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><polygon points="5 3 19 12 5 21 5 3"/></svg>`,U=`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>`,W=`<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-4.55"/></svg>`,G=(e,t)=>`
  ...
  `).join(``),le=[...new Set(w.flatMap(e=>e.techStack))].slice(0,8),ue=[...new Set(w.map(e=>String(e.year)))].sort((e,t)=>Number(t)-Number(e)),K=[...new Set(w.map(e=>e.role||`Individual`))],q=(e,t)=>e.map(e=>`
    <button class="proj-filter-opt" data-filter-group="${t}" data-filter-val="${e}" type="button">${e}</button>
  `).join(``),de=(e,t)=>N(e.type)?`
      <video
    ...
    `:P(e.type)?`
      <div class="proj-modal-pdf-preview" id="modalMainPreview-${t}" data-pdf-src="${e.src}">
        <div class="proj-modal-pdf-icon">${U}</div>
    ...
    <img
      ...
      draggable="false"
    >
  `,fe=(e,t,n,r)=>{let i=r?` is-active`:``,a=`
    (function(el){
      ...
      if(!mainWrap) return;
      mainWrap.innerHTML = ${JSON.stringify(de(e,n))};
    })(this)
  `.replace(/\s+/g,` `).trim();if(e.thumbnail){let n=``;return N(e.type)?n=`<div class="proj-modal-thumb-badge-icon">${H}</div>`:P(e.type)&&(n=`<div class="proj-modal-thumb-badge-icon">${U}</div>`),`
  ...
  `},me=()=>w.map(e=>{let t=M(e),n=e.isWebsite?`
    ...
    `:pe(e),i=e.githubUrl||`https://github.com/nanditosetyawan`;return`
    ...
    <div class="projects-inner">
      ...
      <div class="projects-bottom-bar">
        ...
        <div class="proj-search-wrap">
          <span class="proj-search-icon" aria-hidden="true">${ae}</span>
          <input
            type="search"
            id="projSearch"
...
`,ge=(e,t,n)=>{let r=`<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="1100" viewBox="0 0 1600 1100"><defs><linearGradient id="g" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FFFDF8"/><stop offset="100%" stop-color="#FCF8F1"/></linearGradient></defs><rect width="1600" height="1100" fill="url(#g)"/><rect x="60" y="60" width="1480" height="980" fill="none" stroke="#E8E1D7" stroke-width="4"/><text x="800" y="450" font-family="sans-serif" font-size="110" font-weight="800" fill="#1A312C" text-anchor="middle" letter-spacing="-2">${e}</text><text x="800" y="560" font-family="sans-serif" font-size="52" font-weight="600" fill="#428475" text-anchor="middle" letter-spacing="4">${t}</text><text x="800" y="700" font-family="sans-serif" font-size="40" font-weight="500" fill="#53645F" text-anchor="middle" letter-spacing="8">${n}</text></svg>`;return`data:image/svg+xml;charset=UTF-8,`+encodeURIComponent(r)},_e=[{id:`azure`,title:`Official Practice Question Set: AWS Certified Cloud Practitioner (CLF-C02 Bahasa Indonesia)`,description:`A certificate that reflects growing familiarity with cloud concepts, service models, and basic deployment thinking.`,details:`The certification shows initiative in learning cloud fundamentals and complements web development work with broader technical awareness.`,year:2025,tags:[`Certificate`,`2025`],certificates:[new URL(`/portofolio-sultannang-nandito-setiyawan/assets/Official%20Practice%20Question%20Set-E6RMHTZ4.webp`,``+import.meta.url).href],image:new URL(`/portofolio-sultannang-nandito-setiyawan/assets/AWS-5J7aZdO_.webp`,``+import.meta.url).href,issuedAt:`12 Mei 2026`},{id:`workshop`,title:`Frontend Workshop Participation`,description:`Completed an intensive frontend engineering workshop.`,details:`The details can be updated later with actual documentation or a certificate image.`,year:2024,tags:[`Workshop`,`2024`],certificates:[ge(`WORKSHOP`,`Frontend Practice`,`Participation`)]},{id:`presentation`,title:`Public Speaking Session`,description:`A public speaking and project presentation seminar.`,details:`Focusing on communication and clarity.`,year:2023,tags:[`Seminar`,`2023`],certificates:[ge(`CAMPUS`,`Project Presentation`,`Recognition`)]}],ve=new URL(`/portofolio-sultannang-nandito-setiyawan/assets/reload-CPAj83QN.png`,``+import.meta.url).href,ye=new URL(`data:image/png;base64,`,``+import.meta.url).href,be=(e,t)=>{let n=``;for(let r=1;r<=5;r++)if(e>=r)n+=`
      ...
      `;return`<div class="review-stars-wrap">${n}</div>`},J=(e,t)=>`
  ...
  `,Y=()=>{let e=_e.map((e,t)=>{let n=t>=2?`hidden extra-achieve`:``,r=e.certificates.length>1?`${e.certificates.length} FILES`:`PREVIEW`;return`
      <article class="accordion elevated achievement-item ${n}" data-accordion>
        <button class="achievement-btn" data-accordion-btn>
          ...
          <div class="achievement-toggle">
            <img src="${ye}" class="chev achievement-chev" alt="Toggle">
          </div>
        </button>
    ...
    `}).join(``),t=[...T].reverse(),n=[...t,...t].map((e,t)=>J(e,t)).join(``),r=[...t,...t].map((e,t)=>J(e,t+100)).join(``);return`
...
`,window.addEventListener(`DOMContentLoaded`,()=>{Ae(),window.addEventListener(`load`,()=>{let e=document.getElementById(`loadingScreen`);e&&window.setTimeout(()=>{e.classList.add(`is-hidden`),window.setTimeout(()=>e.remove(),500)},1800)})});export{l as n,o as t};