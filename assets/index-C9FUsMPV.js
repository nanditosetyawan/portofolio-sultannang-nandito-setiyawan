(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=new URL(`/portofolio-sultannang-nandito-setiyawan/assets/white_mode-C2emF1m6.png`,``+import.meta.url).href;new URL(`/portofolio-sultannang-nandito-setiyawan/assets/dark_mode-BcUgIVO5.png`,``+import.meta.url).href;var t=()=>`
        ...
        <div class="mx-auto max-w-7xl px-4 md:px-8 py-4 md:py-3 flex items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-2 shrink-0">
            <button id="themeToggle" class="w-11 h-11 rounded-full border border-border bg-white/70 flex items-center justify-center hover:bg-surface transition" aria-label="Toggle theme">
              <img id="themeIcon" src="${e}" alt="Toggle theme" class="w-6 h-6 object-contain">
            </button>
  ...
  `,n={name:`Nandito Setiyawan`,badge:`Information Systems Student`,description:`I build clean, modern digital experiences through web development, design thinking, and project-based learning. This portfolio shows the work I have completed and the direction I am growing toward.`,resumeLink:`#`,whatsapp:`#`,instagram:`#`,github:`#`,linkedin:`#`,heroImages:[`https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=1200&q=80`,`https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=1200&q=80`,`https://images.unsplash.com/photo-1507591064344-4c6ce005b128?auto=format&fit=crop&w=1200&q=80`,`https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=1200&q=80`,`https://images.unsplash.com/photo-1500917293891-ef795e70e1f6?auto=format&fit=crop&w=1200&q=80`]},r=()=>`
        ...
        <div class="grid lg:grid-cols-12 gap-10 xl:gap-14 items-start">
          <div class="lg:col-span-7 xl:col-span-7 reveal pt-6 md:pt-10 lg:pt-14">
            ...
            <div class="mt-8 flex flex-wrap gap-3">
              <a href="${n.linkedin}" class="btn-primary inline-flex items-center gap-2 px-5 py-3 rounded-full font-bold transition">
                <span class="material-symbols-outlined text-[20px]">launch</span> LinkedIn
              </a>
              <a href="${n.resumeLink}" class="btn-secondary inline-flex items-center gap-2 px-5 py-3 rounded-full font-bold transition">
                <span class="material-symbols-outlined text-[20px]">download</span> Download CV
              </a>
            </div>

            <div class="mt-8 flex flex-wrap gap-3">
              <a href="${n.whatsapp}" class="chip-dark px-4 py-2 rounded-full text-sm font-semibold">WhatsApp</a>
              <a href="${n.instagram}" class="chip-dark px-4 py-2 rounded-full text-sm font-semibold">Instagram</a>
              <a href="${n.github}" class="chip-dark px-4 py-2 rounded-full text-sm font-semibold">GitHub</a>
            </div>
          </div>
    ...
    <section id="projects" class="stage relative py-20 md:py-28 section-wrap">
      <div class="mx-auto max-w-7xl px-4 md:px-8">
        ...
        <div class="space-y-4" id="projectContainer">
          ${a.map((e,t)=>`
      <article class="accordion elevated rounded-[1.8rem] p-4 md:p-5 ${t>=3?`hidden extra-project`:``}" data-accordion>
        <button class="w-full flex flex-col md:flex-row md:items-center gap-4 text-left" data-accordion-btn>
          ...
          <div class="w-11 h-11 rounded-full bg-surface2 border border-border flex items-center justify-center shrink-0 ml-auto">
            <img src="${s}" class="chev transition-transform duration-500 w-5 h-5 object-contain" alt="Toggle">
          </div>
        </button>
    ...
    <section id="achievements" class="stage alt relative py-20 md:py-28 section-wrap">
      <div class="mx-auto max-w-7xl px-4 md:px-8">
        ...
        <div class="mt-10 space-y-4">
          ${u.map((e,t)=>{let n=t>=2?`hidden extra-achieve`:``,r=e.certificates.length>1?`${e.certificates.length} FILES`:`PREVIEW`;return`
      <article class="accordion elevated rounded-[1.8rem] p-5 md:p-6 ${n}" data-accordion>
        <button class="w-full flex flex-col md:flex-row md:items-center gap-4 text-left" data-accordion-btn>
          ...
          <div class="w-11 h-11 rounded-full bg-surface2 border border-border flex items-center justify-center shrink-0 ml-auto">
            <img src="${f}" class="chev transition-transform duration-500 w-5 h-5 object-contain" alt="Toggle">
          </div>
        </button>
...
`,h=`/portofolio-sultannang-nandito-setiyawan/assets/reload-CPAj83QN.png`,g=`/portofolio-sultannang-nandito-setiyawan/assets/back_load-CEEf4z4X.png`,_=`/portofolio-sultannang-nandito-setiyawan/assets/white_mode-C2emF1m6.png`,v=`/portofolio-sultannang-nandito-setiyawan/assets/dark_mode-BcUgIVO5.png`,y=()=>{let e=document.getElementById(`topNav`),t=document.getElementById(`navShell`),n=document.getElementById(`desktopNav`),r=document.getElementById(`navActivePill`),i=Array.from(document.querySelectorAll(`[data-nav-link]`)),a=document.getElementById(`mobileFloatingBurger`),o=document.getElementById(`themeToggle`),s=document.getElementById(`themeIcon`),c=document.getElementById(`menuBtn`),l=document.getElementById(`mobileSidebar`),u=document.getElementById(`closeSidebar`),d=document.getElementById(`sidebarBackdrop`),f=[`hero`,`about`,`projects`,`achievements`,`contact`].map(e=>document.getElementById(e)).filter(e=>!!e),p=()=>{l&&(l.classList.remove(`hidden`),l.classList.add(`block`),document.body.classList.add(`overflow-hidden`))},m=()=>{l&&(l.classList.add(`hidden`),l.classList.remove(`block`),document.body.classList.remove(`overflow-hidden`))},y=t=>{let n=document.getElementById(t);if(!n)return;let r=e?.getBoundingClientRect().height??0,i=window.scrollY+n.getBoundingClientRect().top-r-8;window.scrollTo({top:Math.max(i,0),behavior:`smooth`})},b=Array.from(document.querySelectorAll(`#desktopNav [data-nav-link]`)),x=()=>{let n=window.scrollY>18,r=window.innerWidth<768;t&&t.classList.toggle(`is-scrolled`,n),e&&a&&(r?(e.classList.toggle(`mobile-hidden`,n),a.classList.toggle(`show`,n),a.classList.toggle(`left`,n)):(e.classList.remove(`mobile-hidden`),a.classList.remove(`show`,`left`)))};i.forEach(e=>{e.addEventListener(`click`,t=>{let n=e.getAttribute(`href`);if(!n?.startsWith(`#`))return;t.preventDefault();let r=n.slice(1);E(r),m(),y(r)})}),o?.addEventListener(`click`,()=>{let e=document.documentElement.classList.toggle(`dark`);s&&(s.src=e?v:_,s.alt=e?`Dark mode`:`Light mode`)}),c?.addEventListener(`click`,p),a?.addEventListener(`click`,p),u?.addEventListener(`click`,m),d?.addEventListener(`click`,m);let S=document.querySelectorAll(`.reveal`),C=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting&&e.target.classList.add(`in`)})},{threshold:.12});S.forEach(e=>C.observe(e));let w=`hero`,T=()=>{if(!n||!r||b.length===0)return;let e=window.innerHeight*.35,t=window.innerHeight*.1,a=0,o=0,s=0,c=0;for(let n=0;n<f.length;n++)f[n].getBoundingClientRect().top<=e+t&&(c=n);a=c,o=c;for(let n=1;n<f.length;n++){let r=f[n].getBoundingClientRect().top;if(r>e-t&&r<e+t){a=n-1,o=n,s=1-(r-(e-t))/(2*t);break}}window.innerHeight+window.scrollY>=document.body.offsetHeight-10&&(a=f.length-1,o=f.length-1,s=0);let l=n.getBoundingClientRect(),u=b[a].getBoundingClientRect(),d=b[o].getBoundingClientRect(),p=u.left-l.left,m=p+u.width,h=d.left-l.left,g=h+d.width,_=p,v=m;if(h>p){let e=Math.min(1,s*2),t=Math.max(0,(s-.5)*2);_=p+(h-p)*t,v=m+(g-m)*e}else if(h<p){let e=Math.min(1,s*2),t=Math.max(0,(s-.5)*2);_=p-(p-h)*e,v=m-(m-g)*t}let y=v-_;r.style.transition=`none`,r.style.transform=`translateX(${_}px)`,r.style.width=`${y}px`,r.style.opacity=`1`;let x=f[s<.5?a:o].id;x!==w&&(w=x,i.forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`href`)===`#${w}`)}))};window.addEventListener(`scroll`,()=>{requestAnimationFrame(T)},{passive:!0}),setTimeout(()=>requestAnimationFrame(T),100);let E=e=>{i.forEach(t=>{t.classList.toggle(`active`,t.getAttribute(`href`)===`#${e}`)})};E(`hero`);let D=0,O=window.scrollY,k=!1,A=null,j=null,M=null,N=()=>{k||(k=!0,e?.classList.add(`nav-hidden`))},P=()=>{k&&(k=!1,e?.classList.remove(`nav-hidden`))},F=()=>{M&&=(clearTimeout(M),null)},I=()=>{F(),A=null};window.addEventListener(`scroll`,()=>{D||=window.requestAnimationFrame(()=>{let e=window.scrollY,t=e>O;j&&=(clearTimeout(j),null),t&&e>80?(A===null&&(A=Date.now(),F(),M=setTimeout(N,3e3)),j=setTimeout(()=>{(A===null?0:Date.now()-A)>=3e3&&N(),I()},250)):(I(),P()),O=e,x(),D=0})},{passive:!0}),window.addEventListener(`resize`,x),x(),document.querySelectorAll(`[data-accordion]`).forEach(e=>{let t=e.querySelector(`[data-accordion-btn]`),n=e.querySelector(`.accordion-body`),r=e.querySelector(`.chev`),i=!1,a=()=>{n&&n.classList.toggle(`hidden`,!i),r&&(r.style.transform=i?`rotate(180deg)`:`rotate(0deg)`),t?.setAttribute(`aria-expanded`,String(i))};a(),t?.addEventListener(`click`,()=>{r&&r.classList.add(`spin`),window.setTimeout(()=>{i=!i,a(),r&&r.classList.remove(`spin`)},280)})});let L=(e,t)=>{let n=document.getElementById(e),r=document.getElementById(`${e}Icon`);if(!n||!r)return;let i=Array.from(document.querySelectorAll(t)),a=0;n.addEventListener(`click`,()=>{if(r.classList.add(`spin`),a>=i.length)i.forEach(e=>{e.classList.remove(`show`)}),setTimeout(()=>{i.forEach(e=>{e.classList.add(`hidden`)}),r.src=h,r.classList.remove(`spin`)},550),a=0;else{let e=Math.min(a+3,i.length);setTimeout(()=>{for(let t=a;t<e;t++){let e=i[t];e.classList.remove(`hidden`),e.offsetWidth,setTimeout(()=>{e.classList.add(`show`)},(t-a)*220)}a=e,a===i.length&&(r.src=g)},250),setTimeout(()=>{r.classList.remove(`spin`)},650)}})};L(`projectsToggle`,`.extra-project`),L(`achievementsToggle`,`.extra-achieve`),document.querySelectorAll(`.certificate-stage`).forEach(e=>{let t=e.getAttribute(`data-cert-images`);if(!t)return;let n=[];try{n=JSON.parse(t)}catch{n=[]}if(!n.length)return;let r=e.getAttribute(`data-cert-title`)||`Certificate`,i=e.querySelector(`.cert-img`),a=e.querySelector(`.download-btn`),o=e.querySelector(`.carousel-prev`),s=e.querySelector(`.carousel-next`),c=0,l=e=>{i&&(i.src=n[e],i.style.opacity=`1`)};if(n.length>1&&i){o?.classList.remove(`hidden`),s?.classList.remove(`hidden`);let e=window.setInterval(()=>{i&&(i.style.opacity=`0`,window.setTimeout(()=>{c=(c+1)%n.length,l(c)},280))},5e3);o?.addEventListener(`click`,t=>{t.stopPropagation(),clearInterval(e),c=(c-1+n.length)%n.length,l(c)}),s?.addEventListener(`click`,t=>{t.stopPropagation(),clearInterval(e),c=(c+1)%n.length,l(c)})}else o?.classList.add(`hidden`),s?.classList.add(`hidden`),l(0);a?.addEventListener(`click`,e=>{e.stopPropagation(),n.forEach((e,t)=>{let n=document.createElement(`a`);n.href=e,n.download=`${r}_File_${t+1}.svg`,document.body.appendChild(n),n.click(),n.remove()})})});let R=document.getElementById(`heroPhotoStack`);if(R){let e=Array.from(R.querySelectorAll(`[data-stack-card]`)),t=e.length;if(t>1){let n=0,r=()=>{e.forEach((e,n)=>{e.classList.remove(...Array.from({length:t},(e,t)=>`pos-${t}`))}),e.forEach((e,r)=>{let i=(r-n+t)%t;e.classList.add(`pos-${i}`)}),n=(n+1)%t};R.addEventListener(`click`,r),setInterval(r,3e3)}}},b=document.querySelector(`#app`);b.innerHTML=`
...
`,window.addEventListener(`DOMContentLoaded`,()=>{y(),window.addEventListener(`load`,()=>{let e=document.getElementById(`loadingScreen`);e&&window.setTimeout(()=>{e.classList.add(`is-hidden`),window.setTimeout(()=>e.remove(),500)},1800)})});